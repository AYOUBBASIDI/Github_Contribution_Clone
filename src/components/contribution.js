            ...
            <div className="w-[60rem]">
                ...
                <div className="flex justify-between w-full mt-4">
                    ...
                    <div className="flex flex-col gap-2">
                        <button className="text-[#e6edf3] text-[14px] py-[.5rem] pl-4 pr-16 rounded bg-[#1f6feb] ">2023</button>
                        <button className="text-[#e6edf3] text-[14px] py-[.5rem] pl-4 pr-16 rounded hover:bg-[#161b22]">2022</button>
                        <button className="text-[#e6edf3] text-[14px] py-[.5rem] pl-4 pr-16 rounded hover:bg-[#161b22]">2021</button>
                    </div>
                </div>
            </div>
        </div>
